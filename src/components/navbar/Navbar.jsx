  ...
  return (
      ...
      <div className="Navbar">
        ...
        <div className="Navbar-first-page">
          <div className="logo">
            <img className="logo-img" src="https://xb.uz/cdn/2/uploads/2024/03/04/08/03/a9rEzLeFNa0sSV_AlsJp17dhAqU1ypaKcnQFHmVyrznwb7FHRzEGrSUzVY1TGmzt.jpg" alt="" />
          </div>
          ...
          <div className="navbar-item-page">
            ...
            <div className="navbar-item-page2">
              <Link to="./like">   <FaHeart className="heart"/></Link>
